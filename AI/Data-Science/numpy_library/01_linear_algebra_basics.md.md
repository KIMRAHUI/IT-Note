...
* **행렬 예시 (A):**
  * `A = [1, 2], [3, 4], [5, 6](./1, 2], [3, 4], [5, 6.md)` (3행 2열 행렬, 3 x 2 Matrix)
...
* **행렬 연산 규칙:**
  ...
  * **행렬 곱 (Matrix Multiplication):**
    ...
    * 예시: `[1, 2], [3, 4](./1, 2], [3, 4.md) * [5], [6](./5], [6.md) = [(1*5 + 2*6), (3*5 + 4*6)]^T = [17, 39]^T`
...
* **연립방정식 예시:**
  ...
  * `x - y = 1`
* **행렬 표현 (Ax = b):**
  * `[2, 1], [1, -1](./2, 1], [1, -1.md) * [x], [y](./x], [y.md) = [4], [1](./4], [1.md)`
...
A_sys = np.array([2, 1], [1, -1](./2, 1], [1, -1.md))
b_sys = np.array([4, 1])
